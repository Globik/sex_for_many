...
create or replace function on_token_transfer(tom varchar(16),fro varchar(16), amt int, typ int, pid text) returns void
language plpgsql as $$
declare
p numeric;
begin
...
insert into token_transfer(tom,fro,amt,typ,pid) values(on_token_transfer.tom,on_token_transfer.fro,on_token_transfer.amt,on_token_transfer.typ,on_token_transfer.pid);
end;
$$;
