...
${n.user ? `<a href="/userpay/${n.user.id}"><li>${n.user.lng == 'ru' ? 'Личный кабинет' : 'Dashboard'}</a>`:''}
<a href="/obi"><li>${n.user ? n.user.lng == 'ru' ? 'Доска объявлений' : 'Message board' : 'Доска объявлений'}</a>
<a href="/home/users"><li>${n.user ? n.user.lng == 'ru' ? 'Пользователи' : 'Users' : 'Пользователи'}</a>
