...
const PAYOUT_INFO = function(n){
	return {
		text: `Привет ${n.bname}!Вам выплата ${n.amount} биткоинов от ${site_name} на биткоин адрес ${n.bcard}. Удачного дня!
		Hello ${n.bname}! You're about receiving ${n.amount} BTC from ${site_name} to your BTC address ${n.bcard}. Have a nice day!`,
		html: `Привет ${n.bname}!Вам выплата ${n.amount} биткоинов от ${site_name} на биткоин адрес ${n.bcard}. Удачного дня!
		<br><br>Hello ${n.bname}! You're about receiving ${n.amount} BTC from ${site_name} to your BTC address ${n.bcard}. Have a nice day!`
		}
	}

module.exports = {WELCOME, AFTER_REGISTRATION, PAYOUT_INFO}
